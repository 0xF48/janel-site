...
export function BookListItem({ book }: { book: Book }) {
	return (
		<div className="w-full py-8 px-8 border-main-600 border-solid border-r-1 border-b-1 items-center flex flex-col justify-start font-mono ">
			...
			<Link href={`/books/${book.id}`} className="transition-all hover:bg-main-500 bg-main-600 max-w-[15em]  rounded-2xl flex-col overflow-hidden p-2  w-full h-[23em] gap-2 flex items-center justify-center ring-3 ring-main-500 hover:ring-main-400">
