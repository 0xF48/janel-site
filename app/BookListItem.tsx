...
export function BookListItem({ book }: { book: Book }) {
	return (
		<div className="w-full py-8 px-8 border-main-600 border-solid border-r-1 border-b-1 items-start flex flex-col justify-start font-mono ">
			...
			<Link href={`/books/${book.id}`} className="hover:bg-main-500 bg-main-600 rounded-3xl flex-col overflow-hidden p-8  w-full h-[20em] flex items-center justify-center ring-4 ring-main-500">
